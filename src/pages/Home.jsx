    ...
    return (
        <div className="home-wrapper">
            ...
            <header className="home-hero">
                ...
                <img
                    src="https://placehold.co/1600x900?text=Nigerian+Feast+Table"
                    alt="Hero Background"
                ...
                <div className="hero-content-centered">
                    ...
                    <button className="btn-hero-orange">
                        Discover what's new
                    </button>
                </div>
            ...
            <section className="promo-section">
                ...
                <div className="promo-overlay">
                    <div className="promo-text">
                        ...
                        <p>
                            Explore exciting new dishes, crafted with the
                            freshest ingredients and authentic Nigerian flavors.
                            Limited time offer!
                        </p>
                        <button className="btn-hero-orange">
                            Discover what's new
